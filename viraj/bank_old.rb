...
def register(users_list:, transactions:, password:)
...
def login(users_list)
  ...
  if get_valid_input("Enter new password. (6 digit, Numbers, letters allowed)", /\A[a-zA-Z\d]{6}\z/) == users_list[user_id][:password]
